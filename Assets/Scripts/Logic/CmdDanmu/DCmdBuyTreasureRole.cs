...
[CDanmuCmdAttrite(CDanmuEventConst.BuyTreasureRole)]
public class DCmdBuyTreasureRole : CDanmuCmdAction
{
    ...
    void BuyTreasure(string content, CPlayerBaseInfo player)
    {
        ...
        try
        {
            ...
            int nCmdIdx = content.IndexOf(CDanmuEventConst.BuyTreasureRole) + CDanmuEventConst.BuyTreasureRole.Length;
            ...
            for (int i = 0; i < listTBLInfos.Count; i++)
            {
                if (listTBLInfos[i].nContentID == nItemID &&
                   listTBLInfos[i].emType == ST_ShopTreasure.EMItemType.Role)
                {
            ...
            CHttpParam pReqParams = new CHttpParam(
               ...
               new CHttpParamSlot("itemType", ((int)ST_ShopTreasure.EMItemType.Role).ToString())
            );
