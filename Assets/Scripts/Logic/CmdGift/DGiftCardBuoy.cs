...
//[CDanmuGiftAttrite(CDanmuGiftConst.CardFuPiao)]
public class DGiftCardBuoy : CDanmuGiftAction
{
    public override void DoAction(CDanmuGift dm)
    {
        ...
        if (pPlayer == null)
        {
            ...
            //    {
            //        GetFishPiao(nGiftNum, info, EMGiftType.fishPiao);
            //    }),
            //    pParamLogin);
        ...
        {
            GetFishPiao(nGiftNum, pPlayer, EMGiftType.fishPiao);
        }

        ////给主播加浮漂
        //if (CPlayerMgr.Ins.pOwner != null && CPlayerMgr.Ins.pOwner.uid != uid)
        //{
        //    GetFishPiao(nGiftNum, CPlayerMgr.Ins.pOwner, EMGiftType.fishPiao);
        //}
    }

    void GetFishPiao(long num, CPlayerBaseInfo info, EMGiftType giftType)
    {
