...
public class LocalFileManage : CSingleCompBase<LocalFileManage>
{
    ...
    public void SaveFileAsyc(string strContent, string strSavePath, bool bReplace = true, DelegateNFuncCall call = null)
    {
        ISaveFileInfo pSaveInfo = new ISaveFileInfo();
        pSaveInfo.lGuid = CHelpTools.GenerateId();
        pSaveInfo.szFileName = "";
        pSaveInfo.szFilePath = strSavePath;
        pSaveInfo.szContent = strContent;
        pSaveInfo.bReplace = bReplace;
        pSaveInfo.callSuc = call;
    ...
    public static void ExportFile(string content, string fileName)
    {
        ...
        string path = FileBrowser.Instance.SaveFile("Save file", "", fileName, extensions);
