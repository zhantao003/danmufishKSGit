...
public class UIBroadCastRollEvent : MonoBehaviour
{
    public delegate void OnDelegateChgSlot(UIBroadCastSlot slot, int idx);
    public OnDelegateChgSlot dlgChgSlot;
    public DelegateIFuncCall dlgRollEnd;

    // 奖励图片
    public UIBroadCastSlot[] arrQuestSlots;
