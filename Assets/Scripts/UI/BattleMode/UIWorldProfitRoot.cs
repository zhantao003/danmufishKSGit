...
public class UIWorldProfitRoot : MonoBehaviour
{
    public UIBattleWorldProfitSlot[] pWorldProfitSlot;
    ...
    void Refresh()
    {
        ...
        {
            if (i >= pWorldProfitSlot.Length)
                break;
            pWorldProfitSlot[nShowIdx].SetActive(true);
            pWorldProfitSlot[nShowIdx].SetInfo(listInfo[i]);
            nShowIdx++;
        }
        for (int i = nShowIdx; i < pWorldProfitSlot.Length; i++)
        {
            if (i >= pWorldProfitSlot.Length)
                break;
            pWorldProfitSlot[i].SetActive(false);
        }
    }
