...
public class HHandlerShowDraw : INetEventHandler
{
    public EMDrawType emDrawType;
    public HHandlerShowDraw(EMDrawType drawType)
    {
        emDrawType = drawType;
    }
    ...
    public void OnMsgHandler(CLocalNetMsg pMsg)
    {
           ...
           CGameColorFishMgr.Ins.pMap != null)
        {
            ...
            delegate (Object res, object data, bool bSuc)
            {
                ...
                pBox.Init(uid, count, listInfos, emDrawType);
            });
        }
        else
        {
            ...
            if (uiGetAvatar != null)
            {
                ...
                {
                    uiGetAvatar.AddGiftGachaBoxSlot(pPlayer, listInfos[i], emDrawType);
                }
            }
        }
