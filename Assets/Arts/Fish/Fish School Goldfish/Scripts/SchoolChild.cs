...
public class SchoolChild:MonoBehaviour{
	...
	public void RandomizeStartAnimationFrame(){
		Animation pAnimation = _model.GetComponent<Animation>();
  ...
  //      Animator pAnimceCtrl = _model.GetComponent<Animator>();
		//pAnimceCtrl.Play(pAnimceCtrl.GetCurrentAnimatorStateInfo(0).fullPathHash, 0, Random.value * 1F);
	}
	...
	public void SetAnimationSpeed(){
		...
		foreach (AnimationState state in pAnimation)
        {
