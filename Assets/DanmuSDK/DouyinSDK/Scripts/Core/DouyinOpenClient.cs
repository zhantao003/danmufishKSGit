...
namespace DouyinDanmu
{
    public class DouyinOpenClient : MonoBehaviour
    {
        ...
        public const string DY_GETTOKEN = "/api/checkToken";
        public const string DY_STARTTASK = "/api/startDanmuTask";
        public const string DY_ENDTASK = "/api/endDanmuTask";
        public const string DY_GIFTSHOW = "/api/showGiftList";
